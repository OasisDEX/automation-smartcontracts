...
export enum AutomationServiceName {
    ...
    SPARK_PROXY_ACTIONS = 'SPARK_PROXY_ACTIONS',
    UNISWAP_ROUTER = 'UNISWAP_ROUTER',
    UNISWAP_FACTORY = 'UNISWAP_FACTORY',
    AUTOMATION_DPM_ADAPTER = 'AUTOMATION_DPM_ADAPTER',
    AUTOMATION_AAVE_ADAPTER = 'AUTOMATION_AAVE_ADAPTER',
    AUTOMATION_SPARK_ADAPTER = 'AUTOMATION_SPARK_ADAPTER',
}
