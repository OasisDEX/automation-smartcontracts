...
const addresses = {
    [Network.MAINNET]: {
        ...
        AUTOMATION_CM_BASIC_BUY_COMMAND: '0x0000000000000000000000000000000000000000',
        AUTOMATION_CM_BASIC_SELL_COMMAND: '0x0000000000000000000000000000000000000000',
        AUTOMATION_BOT_AGGREGATOR: '0x0000000000000000000000000000000000000000',
        CONSTANT_MULTIPLE_VALIDATOR: '0x0000000000000000000000000000000000000000',
    },
    [Network.GOERLI]: {
        ...
        AUTOMATION_CM_BASIC_BUY_COMMAND: '0xcbAAAe60EeAB8B3DF33fA84f704C0c43CEC29F73',
        AUTOMATION_CM_BASIC_SELL_COMMAND: '0x15c595cE24576924b2302BBcAD552E3dAdFA4469',
        AUTOMATION_BOT_AGGREGATOR: '0x776eAe37662b4D70472E0D917e5783ea58A73d95',
        CONSTANT_MULTIPLE_VALIDATOR: '0xeb03a3276b463a9754E3775844ea22E32a6020F1',
    },
}
...
export function getCommandAddress(network: string | Network, type: TriggerType) {
    ...
    switch (type) {
        ...
        case TriggerType.CM_BASIC_BUY:
            return addresses.AUTOMATION_CM_BASIC_BUY_COMMAND
        case TriggerType.CM_BASIC_SELL:
            return addresses.AUTOMATION_CM_BASIC_SELL_COMMAND
        default:
